...
public class ProductoController {
    ...
    public ResponseEntity<?> getProductosEspecificaciones(@RequestParam(required = false) Long sucursal,
        ...
        try {
            ...
            if (sucursal == null || precioMinimo == null || precioMaximo == null ||
                ...
                productos = productoRepository.ProductosConCaracteristicas(sucursal, precioMinimo, precioMaximo,
                        fechaVencimiento, codigoCategoria);
            }
    ...
    public ResponseEntity<?> getProductosEspecificaciones(@RequestParam(required = false) Long bodega,
    ...
    public ResponseEntity<String> ProductoGuardar(@RequestBody Producto producto) {
        try {
            productoRepository.insertProducto(producto.getNombre(), producto.getPrecioUnitarioVenta(),
