...
public class EspecificacionEmpacadoController {
    ...
    public ResponseEntity<String> EspecificacionEmpacadoGuardar(
            @RequestBody EspecificacionEmpacado especificacionEmpacado) {
        try {
            especificacionEmpacadoRepository.insertEspecificacionEmpacado(especificacionEmpacado.getVolumen_CM3(),
                    especificacionEmpacado.getPeso_Gr());
